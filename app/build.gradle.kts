...
android {
    ...
    defaultConfig {
        applicationId = "com.aistudio.mystickarts.xpkqz"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Uncoment to use Firestore
    // implementation(libs.firebase.firestore)

    // Uncoment ALL four of the following dependencies together to use Firebase Auth and Google
